<%@ Page Title="Add Fee Structure | AQOONHUB SMS" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master" AutoEventWireup="true" CodeBehind="AddFeeStructure.aspx.cs" Inherits="AQOONHUB_SMS.Modules.Finance.AddFeeStructure" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-wrap">
        <nav class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-slate-400 mb-1.5">
            ...
            <span>/</span><span class="font-semibold text-gray-700 dark:text-slate-200">Add</span>
        </nav>
        <h1 class="text-xl md:text-2xl font-bold tracking-tight mb-6">Add Fee Structure</h1>
        ...
        <div class="card p-6">
            <div class="form-grid two-col">
                <div class="field">
                    ...
                    <small class="text-[11px] text-gray-400 mt-1 block">Categories come from <a class="text-brand-600 hover:underline" href="FeeCategories.aspx">Fee Categories</a>.</small>
                ...
                <div class="field">
                    <asp:Label runat="server" AssociatedControlID="ddlDiscountType" Text="Discount Type" />
                    <asp:DropDownList ID="ddlDiscountType" runat="server" CssClass="input" AutoPostBack="true" OnSelectedIndexChanged="ddlDiscountType_Changed">
                        <asp:ListItem Text="No Discount" Value="No Discount" />
                        <asp:ListItem Text="Percentage (%)" Value="Percentage" />
                        <asp:ListItem Text="Fixed Amount" Value="Fixed Amount" />
                    </asp:DropDownList>
                </div>
                <div class="field">
                    <asp:Label runat="server" AssociatedControlID="txtDiscount" Text="Discount Amount" />
                    <asp:TextBox ID="txtDiscount" runat="server" CssClass="input" TextMode="Number" Text="0" Enabled="false" />
                    <small class="text-[11px] text-gray-400 mt-1 block">Enter a percentage (e.g. 10) or a fixed amount, depending on the discount type.</small>
                </div>
                <div class="field">
