<%@ Page Title="Edit Parent | AQOONHUB SMS" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master" AutoEventWireup="true" CodeBehind="EditParent.aspx.cs" Inherits="AQOONHUB_SMS.Modules.Parents.EditParent" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-wrap">
        ...
        <h1 class="text-xl md:text-2xl font-bold tracking-tight mb-6">Edit Parent / Guardian</h1>
