<%@ Page Title="Examination Reports | AQOONHUB SMS" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master" AutoEventWireup="true" CodeBehind="ExaminationReports.aspx.cs" Inherits="AQOONHUB_SMS.Modules.Reports.ExaminationReports" %>
...
<asp:Content ID="b" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cat-wrap">
        <nav class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-slate-400 mb-1.5">
            ...
            <span>/</span><span class="font-semibold text-gray-700 dark:text-slate-200">Examination Reports</span>
        </nav>
        <div class="mb-4"><h1 class="text-xl md:text-2xl font-bold tracking-tight">Examination Reports</h1>
            <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">Exam schedules, marks status, results and rankings.</p></div>
