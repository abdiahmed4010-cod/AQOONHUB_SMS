...
namespace AQOONHUB_SMS.Modules.Reports
{
    public sealed partial class ReportsRepository
    {
        ...
        public DataRow GetSavedReport(int id){var t=ExecuteDataTable("SELECT TOP 1 SavedReportID,ReportName,ReportKey,Category,ConfigurationJson,Visibility,OwnerUserID,IsActive,CreatedAt,UpdatedAt,LastRunAt FROM dbo.SavedReports WHERE SavedReportID=@id",new[]{P("@id",id)});return t.Rows.Count==0?null:t.Rows[0];}
